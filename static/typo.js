...
/*
 * This is some modifications the code by Mike Zeng with some patches for this
 * to be best used for page manager, including performance tweaks and dictionary
 * adds.
*/
...
var Typo = function (dictionary, affData, wordsData, settings) {
	...
	if (dictionary) {
		...
		if (typeof window !== 'undefined' && 'chrome' in window && 'extension' in window.chrome && 'getURL' in window.chrome.extension) {
			...
			if (!affData) affData = this._readFile(path + "/" + dictionary + ".aff");
			if (!wordsData) wordsData = this._readFile(path + "/" + dictionary + ".dic");
		}
