...
<div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
    ...
    <form on:submit|preventDefault={handleSubmit}>
        <div class="mb-4">
            <label for="displayName" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Name (Optional)</label>
            <input
                type="text"
                id="displayName"
    ...
    <div class="mt-4">
        ...
        <button
            ...
            class="mt-4 w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-white font-medium py-2 px-4 rounded-md hover:bg-gray-50 dark:hover:bg-gray-600 disabled:bg-gray-100 disabled:cursor-not-allowed transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 flex items-center justify-center"
        >
            {#if googleLoading}
